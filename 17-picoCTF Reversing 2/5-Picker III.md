...
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 62470` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/526/picker-III.py).
## Solución

```
1.-Descargamos y vemos el código
...
2.-Nos aprovechamos de varios fallos del código y seguimos los siguientes pasos

                                                                                                                                                                                                                                           
┌──(flavio㉿kali)-[~/picoCTF/Reversing/Picker3]
└─$ nc saturn.picoctf.net 62470
==> ?
...
<function win at 0x722364599dc0>
==> 4
...
3.-Decodificamos el mensaje hexadecimal
