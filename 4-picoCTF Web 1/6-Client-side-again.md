...
http://fickle-tempest.picoctf.net:50841
## Solución

```
Inspeccionando el codigo fuente en la parte de debugger intentamos desofuscar
...
copiamos la variable en la consola de la página
...
Array(10) [ "daf93}", "_again_4", "this", "Password Verified", "Incorrect password", "getElementById", "value", "substring", "picoCTF{", "not_this" ]
...
Aprendimos la ofuscación y  des-ofuscar con una página..
## Referencias
