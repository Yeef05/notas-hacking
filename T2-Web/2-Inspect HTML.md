...
Can you get the flag?Go to this [website](http://saturn.picoctf.net:59397/) and see what you can discover.
## Solución

```
# Inspeccionamos el código HTML y ahi se encuentra la flag
...
Visualizamos el código HTML de la página.
## Referencias
